...
library(dplyr)
library(ggplot2)
data.frame(Percent = c(5.8,6.6,6.8,8.2,10.4,12.2, 4.9, 5.3, 5.4, 5.3, 5.9, 6.7), 
  ...
  scale_x_continuous('Sample size', limits = c(0,2200), breaks = c(0,150,250,500,1000,1500,2000), minor_breaks = NULL) +
