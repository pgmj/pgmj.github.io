...
Since the pairwise method has been claimed to be good with small samples [@Finch_French_2019], I was interested to have a quick look at this. We'll use the same 250 datasets again, but randomly select 108 respondents (3 per threshold estimated) from each dataset.
