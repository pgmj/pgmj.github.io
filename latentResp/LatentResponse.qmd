...
RIitemHierarchy(df[,c(1:9)]) +
  ...
  annotate("text", label = "60-80", y = avg4-0.1, x = 9, angle = 90, size = 4.5, color = "darkorange") +
  geom_hline(aes(yintercept = avg2), linetype = 2, color = "red") +
  annotate("rect", xmin = 0, xmax = Inf, ymin = avg2 - sem2, ymax = avg2 + sem2, alpha = .1) +
  annotate("text", label = "20-40", y = avg2-0.1, x = 9, angle = 90, size = 4.5, color = "darkorange") 
